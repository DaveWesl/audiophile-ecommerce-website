        ...
        <div className="footer-container">
            ...
            <div className="logos">
                <ul className="social-media-list">
                    <li><a className="footer-logo" href="https://www.facebook.com">
                            <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" className="svg-icon">
                                <path
                    ...
                    <li><a className="footer-logo" href="https://www.twitter.com">
                            <svg width="24" height="20" xmlns="http://www.w3.org/2000/svg" className="svg-icon">
                                <path
                    ...
                    <li><a className="footer-logo" href="https://www.instagram.com">
                            <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" className="svg-icon">
                                <path
