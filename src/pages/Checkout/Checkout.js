        ...
        <div className="checkout-container">
          <div className="checkout-form">
            ...
            {isEMoneyActive && (
              <>
                <div className="checkout-label-container">
                  <label className="checkout-label" htmlFor="payment-e-number">
                    e-Money Number
                  </label>
                  <input
                    className="checkout-input"
      ...
      <div className="summary">
        ...
        <form className="cart-form1 product-form">
          <div className="cart-quantity product-quantity">
            <button
              className="cart-button1 product-button product-button-1"
              type="button"
            >
              -
            </button>
            <input
              className="cart-button1 product-button product-input"
              type="number"
              id="quantity"
              name="quantity"
              min="1"
        ...
        <div className="cart-h7-total">
          TOTAL<span className="cart-total-price cart-h7">$ 5,396</span>
        </div>
