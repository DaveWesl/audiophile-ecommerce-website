            ...
            <div className='checkout-container'>
                <div className='checkout-form'>
                    ...
                    <div className='checkout-options'>
                        ...
                        <p className='checkout-p'>The ‘Cash on Delivery’ option enables you to pay in cash when our delivery courier arrives at your residence. Just make sure your address is correct so that your order will not be cancelled.</p>
                    </div>
                </div>
