...
function ZX9({onAddToCart}) {
    return ( 
        <div className="zx9">
            ...
            <Images 
                imagesImg1={process.env.PUBLIC_URL + '/assets/product-zx9-speaker/desktop/image-gallery-1.jpg'}
                imagesImg2={process.env.PUBLIC_URL + '/assets/product-zx9-speaker/desktop/image-gallery-2.jpg'}
                imagesImg3={process.env.PUBLIC_URL + '/assets/product-zx9-speaker/desktop/image-gallery-3.jpg'}
            ...
            <Youmayalso 
                YoumayalsoImg1={process.env.PUBLIC_URL + '/assets/shared/desktop/image-zx7-speaker.jpg'}
